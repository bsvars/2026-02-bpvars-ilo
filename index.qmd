---
title: "<span style='color: #1A003F;'>Bayesian Forecasting of Labour Market Indicators Using the R Package [bpvars](https://github.com/bsvars/bpvars)</span>" 
...
### Lecture Slides [as a website](https://bsvars.org/2026-02-bpvars-ilo/) {style="color:#1A003F;"}

### GitHub [repo](https://github.com/bsvars/2026-02-bpvars-ilo) to reproduce the slides and results{style="color:#1A003F;"}

### **bpvars** [website](https://bsvars.org/bpvars) and [CRAN](https://cran.r-project.org/package=bpvars) profile {style="color:#1A003F;"}

### [vignette](https://bsvars.org/bpvars), [tutorial](https://bsvars.org/bpvars) and [manual](https://cloud.r-project.org/web/packages/bpvars/bpvars.pdf) {style="color:#1A003F;"}
